...
function mesesDelAño(array) {
  ...
  if (losmeses.length < 3 ){return "No se encontraron los meses pedidos"};
...
function breakStatement(numero) {
  ...
  for (var i = 1; i <= 10; i++){
    ...
    if(sumatoria === i)
    break
    arraySuma.push(sumatoria) 
  } 
  if (arraySuma.length < 10 ){return "Se interrumpió la ejecución"}
   return arraySuma
}
